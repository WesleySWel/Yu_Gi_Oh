...
function nextDuel() {
    ...
    updateFieldCard(state.fieldCards.player, playerCard);
    updateFieldCard(state.fieldCards.computer, computerCard);
...
function updateFieldCard(field, card) {
    field.querySelector(".card-image").src = card.img;
    field.querySelector(".card-name").textContent = card.name;
    field.querySelector(".card-type").textContent = card.type;
}
